...
namespace Business.ValidationRules.FluentValidation
{
    public class ProductValidator:AbstractValidator<Product>
    {
        public ProductValidator()
        {
            ...
            RuleFor(p => p.ProductName).Must(StartA).WithMessage("Ürünler A harfi ile başlamalı"); 
        }

        private bool StartA(string arg)        //Kendimiz kural yazabiliriz. A ile başlayan isimler .
        {
